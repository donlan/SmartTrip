...
import dong.lan.smarttrip.utils.EmoticonUtil;
...
public class TextMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        tv.setTextColor(App.myApp().getResources().getColor(isSelf() ? R.color.chat_right_text_color : R.color.chat_left_text_color));
