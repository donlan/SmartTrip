...
import dong.lan.smarttrip.ui.im.FriendshipManageMessageActivity;
...
public class FriendshipConversation extends Conversation {
    ...
    public String getLastMessageSummary() {
        ...
        switch (lastMessage.getType()){
            case TIM_FUTURE_FRIEND_PENDENCY_IN_TYPE://我收到的好友申请的未决消息
                return name + App.myApp().getString(R.string.summary_friend_add);
            case TIM_FUTURE_FRIEND_PENDENCY_OUT_TYPE://我发出的好友申请的未决消息
                return App.myApp().getString(R.string.summary_me) + App.myApp().getString(R.string.summary_friend_add_me) + name;
            case TIM_FUTURE_FRIEND_DECIDE_TYPE://已决消息
                return App.myApp().getString(R.string.summary_friend_added) + name;
            case TIM_FUTURE_FRIEND_RECOMMEND_TYPE://好友推荐
                return App.myApp().getString(R.string.summary_friend_recommend) + name;
            default:
                return "";
        }
    }
    ...
    public String getName() {
        return App.myApp().getString(R.string.conversation_system_friend);
