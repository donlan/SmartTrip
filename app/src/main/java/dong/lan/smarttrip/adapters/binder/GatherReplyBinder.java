...
public class GatherReplyBinder extends AbstractRealmBinder<GatherReply> {
    ...
    @Override
    public void setBinderClickListener(BinderClickListener<GatherReply> clickListener) {
        this.clickListener = clickListener;
    }


    @Override
    public BaseRealmAdapter<GatherReply> build(){
        return new BaseRealmAdapter<>(this);
    }

    public  class ViewHolder extends BaseHolder<GatherReply> {
        ...
        @Override
        public void bindData(GatherReply reply) {
